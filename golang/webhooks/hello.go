...
const (
	rootURL    = "http://mattermost-apps-golang-webhooks:8081"
	listenAddr = ":8081"
)
...
var manifest = apps.Manifest{
	...
	Icon:        "icon.png",
	HomepageURL: "https://github.com/mattermost/mattermost-app-examples/golang/webhooks",
