module github.com/mattermost/mattermost-app-examples/golang/serverless/http

go 1.19

require (
	github.com/mattermost/mattermost-app-examples/golang/serverless/function v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/mattermost/mattermost-server/v6 v6.0.0-20220811191350-87cbeafd3635 // indirect
...
replace github.com/mattermost/mattermost-app-examples/golang/serverless/function => ../function
