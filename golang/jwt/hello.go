...
var manifest = apps.Manifest{
	...
	Icon:        "icon.png",
	HomepageURL: "https://github.com/mattermost/mattermost-app-examples/golang/jwt",
	...
	Deploy: apps.Deploy{
		HTTP: &apps.HTTP{
			RootURL: "http://mattermost-apps-golang-jwt:8084",
			UseJWT:  true,
		},
	},
}
...
func main() {
	...
	fmt.Println("Use '/apps install http http://mattermost-apps-golang-jwt" + addr + "/manifest.json' to install the app")
